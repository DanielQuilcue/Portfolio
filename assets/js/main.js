...
const sendEmail = (e) => {
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === '') {
        ...
        // Show message
        contactMessage.textContent = 'White all the input fields 📩'

    }
    else{
        // ServiceId - templateId - #Form - publickey
        emailjs.sendForm('service_iitqa7j','template_v9cof8q','#contact-form','6JfrSoBSpioPi1pQ7')
            .then(() => {
                ...
                alert('OOPS! Something has faied...', error);
            });
...
const scrollUp = () => {
    ...
    // When the scroll is higher than 350 wiewport height, add the show-scroll class to the a tag with the scrollup class
...
// We obtain the current theme tahn the interface has by validating the dark-theme class
